...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-interface tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="../interfaces/_d3adaptor_.d3v3context.html" class="tsd-kind-icon">D3v3<wbr>Context</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module">
			<a href="_d3adaptor_.html#d3adaptor" class="tsd-kind-icon">d3adaptor</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="_d3adaptor_.html#isd3v3" class="tsd-kind-icon">is<wbr>D3V3</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-not-exported">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-is-not-exported"><a href="../interfaces/_d3adaptor_.d3v3context.html" class="tsd-kind-icon">D3v3<wbr>Context</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-external-module"><a href="_d3adaptor_.html#d3adaptor" class="tsd-kind-icon">d3adaptor</a></li>
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported"><a href="_d3adaptor_.html#isd3v3" class="tsd-kind-icon">is<wbr>D3V3</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module">
				<a name="d3adaptor" class="tsd-anchor"></a>
				<h3>d3adaptor</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module">
					<li class="tsd-signature tsd-kind-icon">d3adaptor<span class="tsd-signature-symbol">(</span>d3Context<span class="tsd-signature-symbol">?: </span><a href="../interfaces/_d3v4adaptor_.d3context.html" class="tsd-signature-type">D3Context</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_d3adaptor_.d3v3context.html" class="tsd-signature-type">D3v3Context</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../classes/_d3v4adaptor_.d3stylelayoutadaptor.html" class="tsd-signature-type">D3StyleLayoutAdaptor</a><span class="tsd-signature-symbol"> | </span><a href="../classes/_d3v3adaptor_.d3stylelayoutadaptor.html" class="tsd-signature-type">D3StyleLayoutAdaptor</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/tgdwyer/WebCola/blob/c43ce6c/WebCola/src/d3adaptor.ts#L23">d3adaptor.ts:23</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>provides an interface for use with d3:
								Correct way to create way to construct the d3 cola object is to pass the d3 object into the adaptor function, like so:</p>
							</div>
							<p>  <code>var d3cola = cola.d3adaptor(d3);</code></p>
							<p>Internally, it will figure out if d3 is version 3 or 4 from the version tag and set up the right event forwarding. Defaults to version 3 if the d3 object is not passed.</p>
							<ul>
								<li>uses the d3 event system to dispatch layout events such as:
									o &quot;start&quot; (start layout process)
									o &quot;tick&quot; (after each layout iteration)
								o &quot;end&quot; (layout converged and complete).</li>
								<li>uses the d3 timer to queue layout iterations.</li>
								<li>sets up d3.behavior.drag to drag nodes
									o use <code>node.call(&lt;the returned instance of Layout&gt;.drag)</code> to make nodes draggable
									returns an instance of the cola.Layout itself with which the user
								can interact directly.</li>
							</ul>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> d3Context: <a href="../interfaces/_d3v4adaptor_.d3context.html" class="tsd-signature-type">D3Context</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_d3adaptor_.d3v3context.html" class="tsd-signature-type">D3v3Context</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="../classes/_d3v4adaptor_.d3stylelayoutadaptor.html" class="tsd-signature-type">D3StyleLayoutAdaptor</a>
							<span class="tsd-signature-symbol"> | </span>
							<a href="../classes/_d3v3adaptor_.d3stylelayoutadaptor.html" class="tsd-signature-type">D3StyleLayoutAdaptor</a>
						</h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
				<a name="isd3v3" class="tsd-anchor"></a>
				<h3>is<wbr>D3V3</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">is<wbr>D3V3<span class="tsd-signature-symbol">(</span>d3Context<span class="tsd-signature-symbol">: </span><a href="../interfaces/_d3v4adaptor_.d3context.html" class="tsd-signature-type">D3Context</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_d3adaptor_.d3v3context.html" class="tsd-signature-type">D3v3Context</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/tgdwyer/WebCola/blob/c43ce6c/WebCola/src/d3adaptor.ts#L30">d3adaptor.ts:30</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>d3Context: <a href="../interfaces/_d3v4adaptor_.d3context.html" class="tsd-signature-type">D3Context</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/_d3adaptor_.d3v3context.html" class="tsd-signature-type">D3v3Context</a></h5>
							</li>
						</ul>
