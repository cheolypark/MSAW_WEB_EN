...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-type-alias tsd-parent-kind-external-module">
			<a href="_layout_.html#linknumericpropertyaccessor" class="tsd-kind-icon">Link<wbr>Numeric<wbr>Property<wbr>Accessor</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
			<a href="_layout_.html#isgroup" class="tsd-kind-icon">is<wbr>Group</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-enum tsd-parent-kind-external-module"><a href="../enums/_layout_.eventtype.html" class="tsd-kind-icon">Event<wbr>Type</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Classes</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-class tsd-parent-kind-external-module"><a href="../classes/_layout_.layout.html" class="tsd-kind-icon">Layout</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface tsd-parent-kind-external-module"><a href="../interfaces/_layout_.event.html" class="tsd-kind-icon">Event</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-is-not-exported"><a href="../interfaces/_layout_.group.html" class="tsd-kind-icon">Group</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-has-type-parameter"><a href="../interfaces/_layout_.link.html" class="tsd-kind-icon">Link</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module"><a href="../interfaces/_layout_.linklengthtypeaccessor.html" class="tsd-kind-icon">Link<wbr>Length<wbr>Type<wbr>Accessor</a></li>
							<li class="tsd-kind-interface tsd-parent-kind-external-module"><a href="../interfaces/_layout_.node.html" class="tsd-kind-icon">Node</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Type aliases</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias tsd-parent-kind-external-module"><a href="_layout_.html#linknumericpropertyaccessor" class="tsd-kind-icon">Link<wbr>Numeric<wbr>Property<wbr>Accessor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-not-exported">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported"><a href="_layout_.html#isgroup" class="tsd-kind-icon">is<wbr>Group</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias tsd-parent-kind-external-module">
				<a name="linknumericpropertyaccessor" class="tsd-anchor"></a>
				<h3>Link<wbr>Numeric<wbr>Property<wbr>Accessor</h3>
				<div class="tsd-signature tsd-kind-icon">Link<wbr>Numeric<wbr>Property<wbr>Accessor<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">function</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/tgdwyer/WebCola/blob/c43ce6c/WebCola/src/layout.ts#L71">layout.ts:71</a></li>
					</ul>
				</aside>
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter-siganture">
							<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-alias tsd-is-not-exported">
								<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>t<span class="tsd-signature-symbol">: </span><a href="../interfaces/_layout_.link.html" class="tsd-signature-type">Link</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/_layout_.node.html" class="tsd-signature-type">Node</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
							</ul>
							<ul class="tsd-descriptions">
								<li class="tsd-description">
									...
									<ul class="tsd-parameters">
										<li>
											<h5>t: <a href="../interfaces/_layout_.link.html" class="tsd-signature-type">Link</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/_layout_.node.html" class="tsd-signature-type">Node</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">&gt;</span></h5>
										</li>
									</ul>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-not-exported">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
				...
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-is-not-exported">
					<li class="tsd-signature tsd-kind-icon">is<wbr>Group<span class="tsd-signature-symbol">(</span>g<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/tgdwyer/WebCola/blob/c43ce6c/WebCola/src/layout.ts#L54">layout.ts:54</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>g: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
