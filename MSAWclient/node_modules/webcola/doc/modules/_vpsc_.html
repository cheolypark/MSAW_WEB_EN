...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-class tsd-parent-kind-external-module">
			<a href="../classes/_vpsc_.block.html" class="tsd-kind-icon">Block</a>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module">
			<a href="../classes/_vpsc_.blocks.html" class="tsd-kind-icon">Blocks</a>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module">
			<a href="../classes/_vpsc_.constraint.html" class="tsd-kind-icon">Constraint</a>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module">
			<a href="../classes/_vpsc_.positionstats.html" class="tsd-kind-icon">Position<wbr>Stats</a>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module">
			<a href="../classes/_vpsc_.solver.html" class="tsd-kind-icon">Solver</a>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module">
			<a href="../classes/_vpsc_.variable.html" class="tsd-kind-icon">Variable</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module">
			<a href="_vpsc_.html#removeoverlapinonedimension" class="tsd-kind-icon">remove<wbr>Overlap<wbr>InOne<wbr>Dimension</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class tsd-parent-kind-external-module"><a href="../classes/_vpsc_.block.html" class="tsd-kind-icon">Block</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module"><a href="../classes/_vpsc_.blocks.html" class="tsd-kind-icon">Blocks</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module"><a href="../classes/_vpsc_.constraint.html" class="tsd-kind-icon">Constraint</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module"><a href="../classes/_vpsc_.positionstats.html" class="tsd-kind-icon">Position<wbr>Stats</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module"><a href="../classes/_vpsc_.solver.html" class="tsd-kind-icon">Solver</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module"><a href="../classes/_vpsc_.variable.html" class="tsd-kind-icon">Variable</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-external-module"><a href="_vpsc_.html#removeoverlapinonedimension" class="tsd-kind-icon">remove<wbr>Overlap<wbr>InOne<wbr>Dimension</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module">
				<a name="removeoverlapinonedimension" class="tsd-anchor"></a>
				<h3>remove<wbr>Overlap<wbr>InOne<wbr>Dimension</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module">
					<li class="tsd-signature tsd-kind-icon">remove<wbr>Overlap<wbr>InOne<wbr>Dimension<span class="tsd-signature-symbol">(</span>spans<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">[]</span>, lowerBound<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span>, upperBound<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/tgdwyer/WebCola/blob/c43ce6c/WebCola/src/vpsc.ts#L522">vpsc.ts:522</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Remove overlap between spans while keeping their centers as close as possible to the specified desiredCenters.
								...
								returns a new center for each span.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>spans: <span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">[]</span></h5>
								<ul class="tsd-parameters">
									<li class="tsd-parameter">
										<h5>desired<wbr>Center<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5>
									</li>
									<li class="tsd-parameter">
							...
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> lowerBound: <span class="tsd-signature-type">number</span></h5>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> upperBound: <span class="tsd-signature-type">number</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">object</span></h4>
						<ul class="tsd-parameters">
							<li class="tsd-parameter">
								<h5>lower<wbr>Bound<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5>
							</li>
							<li class="tsd-parameter">
								<h5>new<wbr>Centers<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">[]</span></h5>
							</li>
							<li class="tsd-parameter">
								<h5>upper<wbr>Bound<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5>
							</li>
						</ul>
					</li>
				</ul>
