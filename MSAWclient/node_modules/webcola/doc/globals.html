...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="webcola">WebCola</h1>
			<p>JavaScript constraint based layout for high-quality graph visualization and exploration
			using D3.js and other web-based graphics libraries.<br><a href="http://marvl.infotech.monash.edu/webcola">Homepage with examples</a></p>
			<h2 id="installation">Installation</h2>
			<p>A version suitable for browsers can be found <a href="WebCola/cola.js">here</a> (<a href="WebCola/cola.min.js">minified</a>).</p>
			<h4 id="npm-">Npm:</h4>
			<pre><code>npm <span class="hljs-keyword">install</span> webcola <span class="hljs-comment">--save</span>
</code></pre><p>You can also install it through npm by first adding it to <code>package.json</code>:</p>
			<pre><code><span class="hljs-string">"dependencies"</span>: {
  <span class="hljs-string">"webcola"</span>: <span class="hljs-string">"tgdwyer/WebCola<span class="hljs-subst">#master</span>"</span>
}
</code></pre><p>Then by running <code>npm install</code>.</p>
			<p>####Bower : </p>
			<pre><code><span class="hljs-keyword">bower </span><span class="hljs-keyword">install </span>webcola --save
</code></pre><p>If you use TypeScript, you can get complete TypeScript definitions by installing <a href="https://github.com/DefinitelyTyped/tsd">tsd 0.6</a> and running <code>tsd link</code>.</p>
			<h2 id="building">Building</h2>
			<p><em>Linux/Mac/Windows Command Line:</em></p>
			<ul>
				<li>install <a href="http://nodejs.org">node.js</a></li>
				<li><p>install grunt from the command line using npm (comes with node.js):</p>
					<pre><code> npm install -g grunt-<span class="hljs-keyword">cli</span>
</code></pre></li>
				<li><p>from the WebCola directory:</p>
					<pre><code> npm <span class="hljs-keyword">install</span>
</code></pre></li>
				<li><p>build, minify and test:</p>
					<pre><code><span class="hljs-attribute"> grunt</span>
</code></pre></li>
			</ul>
			<p>This creates the <code>cola.js</code> and <code>cola.min.js</code> files in the <code>WebCola</code> directory, generates <code>index.js</code> for npm, and runs tests.</p>
			<p><em>Visual Studio:</em></p>
			<ul>
				<li>get the <a href="http://www.typescriptlang.org/#Download">typescript plugin</a></li>
				<li>open webcola.sln</li>
			</ul>
			<h2 id="running">Running</h2>
			<p><em>Linux/Mac/Windows Command Line:</em></p>
			<p>Install the Node.js http-server module:</p>
...
</code></pre><p>After installing http-server, we can serve out the example content in the WebCola directory.</p>
			<pre><code>http-<span class="hljs-keyword">server</span> WebCola
</code></pre><p>The default configuration of http-server will serve the exampes on <a href="http://localhost:8080">http://localhost:8080</a>.</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-external-module"><a href="modules/_adaptor_.html" class="tsd-kind-icon">"adaptor"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_batch_.html" class="tsd-kind-icon">"batch"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_d3adaptor_.html" class="tsd-kind-icon">"d3adaptor"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_d3v3adaptor_.html" class="tsd-kind-icon">"d3v3adaptor"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_d3v4adaptor_.html" class="tsd-kind-icon">"d3v4adaptor"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_descent_.html" class="tsd-kind-icon">"descent"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_geom_.html" class="tsd-kind-icon">"geom"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_gridrouter_.html" class="tsd-kind-icon">"gridrouter"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_handledisconnected_.html" class="tsd-kind-icon">"handledisconnected"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_layout_.html" class="tsd-kind-icon">"layout"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_layout3d_.html" class="tsd-kind-icon">"layout3d"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_linklengths_.html" class="tsd-kind-icon">"linklengths"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_powergraph_.html" class="tsd-kind-icon">"powergraph"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_pqueue_.html" class="tsd-kind-icon">"pqueue"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_rbtree_.html" class="tsd-kind-icon">"rbtree"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_rectangle_.html" class="tsd-kind-icon">"rectangle"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_shortestpaths_.html" class="tsd-kind-icon">"shortestpaths"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_vpsc_.html" class="tsd-kind-icon">"vpsc"</a></li>
						</ul>
					</section>
				</div>
			</section>
